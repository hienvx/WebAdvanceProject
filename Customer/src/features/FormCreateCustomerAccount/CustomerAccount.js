...
export function CreateCustomerAccount(props) {
  ...
  return (
    <div className="card text-left" hidden={props.hidden}>
      <div className="card-header">Tạo tài khoản khách hàng</div>
      <div className="card-body">
        <form action="#">
          <div className="form-group">
            <label>Tên đăng nhập</label>
            <input
              readOnly={customer.isSubmit}
              type="text"
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => {
                dispatch(
                  updateValue({ value: e.target.value, option: ["fullName"] })
                );
              }}
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                dispatch(
                  updateValue({ value: e.target.value, option: ["email"] })
                )
              }
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                dispatch(
                  updateValue({ value: e.target.value, option: ["phone"] })
                )
              }
