...
export function Recharge(props) {
  ...
  return (
    <div className="card text-left" hidden={props.hidden}>
      <div className="card-header">Nạp tiền cho khách hàng</div>
        ...
        <form action="#">
          <div className="form-check col-2 icheck-material-blue">
            <input
              ...
              onClick={() => {
                dispatch(
                  updateValue({ value: true, option: ["isUserAccountChecked"] })
                );
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) => {
                dispatch(
                  updateValue({ value: e.target.value, option: ["amount"] })
                );
